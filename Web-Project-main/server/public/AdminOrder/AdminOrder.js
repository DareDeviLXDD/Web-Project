...
let Orders=[
  new Order('1','Mahmoud','Shoes','Nasr city','Delevired','200'),
  new Order('2','Mohsen','T-Shirt','Obour City','Not Delevired','400'),
  new Order('3','Mazen','Pants','Nozha City','Out For Delivery','350')
];
